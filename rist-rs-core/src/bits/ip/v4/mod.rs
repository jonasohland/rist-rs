...
impl<'a> TryFrom<&'a [u8]> for Ipv4PacketView<'a> {
    ...
    fn try_from(data: &'a [u8]) -> Result<Self, Self::Error> {
        ...
        let pv = crate::bits::ip::read_ip_version(data)?;
...
impl<'a> Ipv4PacketView<'a> {
    ...
    pub fn header_len(&self) -> usize {
        Ipv4PacketView::ihl(self.data).expect(crate::internal::INTERNAL_ERR_PRE_VALIDATED)
    }
    ...
    pub fn source_addr(&self) -> crate::net::Ipv4Addr {
        [self.data[12], self.data[13], self.data[14], self.data[15]].into()
    }

    /// Get the destination address
    pub fn dest_addr(&self) -> crate::net::Ipv4Addr {
